                  ...
                  <tr class="odd gradeX" align="center">
                      ...
                      <td class="center">
                        <i class="fa fa-pencil fa-fw"></i>
                         <a href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal{{$order->id}}" data-whatever="@mdo">Edit</a>
                         <!--Edit Order-->
                                 ...
                                 <form action="{{route('order.postedit',$order->id)}}" method="POST">
                                   ...
                                   <div class="form-group">
                                     ...
                                     <select class="form-control" id="recipient-name" name="status">
                                       <option value="1" @if($order->status == 1) {{'selected'}} @endif  >Xác Nhận</option>
                                       <option value="2" @if($order->status == 2) {{'selected'}} @endif  >Đã Chuyển Hàng</option>
                                     </select>
                      ...
                      <td class="center">
                        ...
                        <a onclick="return xacnhanxoa('Bạn có chắc là muốn xóa hay không ?')" href="{{route('order.getdelete',$order->id)}}">Delete</a>
                      </td>
